...
type GetEventsRequest struct {
	...
	// Owner of the event.
	OwnerId uint64 `protobuf:"varint,6,opt,name=owner_id,json=ownerId,proto3" json:"owner_id,omitempty"`
	// Duration before the event to notify the owner from.
	NotifyBeforeFrom int64 `protobuf:"varint,7,opt,name=notify_before_from,json=notifyBeforeFrom,proto3" json:"notify_before_from,omitempty"`
	// Duration before the event to notify the owner to.
	NotifyBeforeTo int64 `protobuf:"varint,8,opt,name=notify_before_to,json=notifyBeforeTo,proto3" json:"notify_before_to,omitempty"`
	// Limit of the events.
...
func (x *GetEventsRequest) GetNotifyBeforeFrom() int64 {
	if x != nil {
		return x.NotifyBeforeFrom
	}
	return 0
}

func (x *GetEventsRequest) GetNotifyBeforeTo() int64 {
	if x != nil {
		return x.NotifyBeforeTo
	}
	return 0
}
...
// GetEventsUpToRequest is a request for the GetEventsUpTo request.
type GetEventsUpToRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Time when the event ends to.
	FinishedTo *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=finished_to,json=finishedTo,proto3" json:"finished_to,omitempty"`
	// Limit of the events.
	Limit uint64 `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty"`
}

func (x *GetEventsUpToRequest) Reset() {
	*x = GetEventsUpToRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetEventsUpToRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetEventsUpToRequest) ProtoMessage() {}

func (x *GetEventsUpToRequest) ProtoReflect() protoreflect.Message {
	mi := &file_EventService_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetEventsUpToRequest.ProtoReflect.Descriptor instead.
func (*GetEventsUpToRequest) Descriptor() ([]byte, []int) {
	return file_EventService_proto_rawDescGZIP(), []int{13}
}

func (x *GetEventsUpToRequest) GetFinishedTo() *timestamppb.Timestamp {
	if x != nil {
		return x.FinishedTo
	}
	return nil
...
func (x *GetEventsUpToRequest) GetLimit() uint64 {
	if x != nil {
		return x.Limit
	}
	return 0
...
var file_EventService_proto_rawDesc = []byte{
	...
	0x22, 0xbd, 0x03, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65,
	...
	0x04, 0x52, 0x07, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x12, 0x2c, 0x0a, 0x12, 0x6e, 0x6f,
	0x74, 0x69, 0x66, 0x79, 0x5f, 0x62, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x5f, 0x66, 0x72, 0x6f, 0x6d,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x10, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x42, 0x65,
	0x66, 0x6f, 0x72, 0x65, 0x46, 0x72, 0x6f, 0x6d, 0x12, 0x28, 0x0a, 0x10, 0x6e, 0x6f, 0x74, 0x69,
	0x66, 0x79, 0x5f, 0x62, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x5f, 0x74, 0x6f, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x42, 0x65, 0x66, 0x6f, 0x72, 0x65,
	0x54, 0x6f, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28,
	...
	0x22, 0x4f, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x73,
	...
	0x6c, 0x22, 0x69, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x55, 0x70,
	0x54, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3b, 0x0a, 0x0b, 0x66, 0x69, 0x6e,
	0x69, 0x73, 0x68, 0x65, 0x64, 0x5f, 0x74, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x0a, 0x66, 0x69, 0x6e, 0x69,
	0x73, 0x68, 0x65, 0x64, 0x54, 0x6f, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x32, 0xfd, 0x03, 0x0a,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x56, 0x0a, 0x11, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x1f,
	0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x20, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x45, 0x76,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3e, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	,
}
...
var file_EventService_proto_goTypes = []interface{}{
	...
	(*GetEventsUpToRequest)(nil),      // 13: event.GetEventsUpToRequest
	(*timestamppb.Timestamp)(nil),     // 14: google.protobuf.Timestamp
}
var file_EventService_proto_depIdxs = []int32{
	14, // 0: event.Event.created_at:type_name -> google.protobuf.Timestamp
	14, // 1: event.Event.finished_at:type_name -> google.protobuf.Timestamp
	14, // 2: event.CreateEventRequest.finished_at:type_name -> google.protobuf.Timestamp
	0,  // 3: event.UpdateEventRequest.event:type_name -> event.Event
	0,  // 4: event.GetEventResponse.event:type_name -> event.Event
	14, // 5: event.GetEventsRequest.created_from:type_name -> google.protobuf.Timestamp
	14, // 6: event.GetEventsRequest.created_to:type_name -> google.protobuf.Timestamp
	14, // 7: event.GetEventsRequest.finished_from:type_name -> google.protobuf.Timestamp
	14, // 8: event.GetEventsRequest.finished_to:type_name -> google.protobuf.Timestamp
	0,  // 9: event.GetEventsResponse.events:type_name -> event.Event
	14, // 10: event.GetEventsUpToRequest.finished_to:type_name -> google.protobuf.Timestamp
	1,  // 11: event.EventService.CreateEvent:input_type -> event.CreateEventRequest
	3,  // 12: event.EventService.UpdateEvent:input_type -> event.UpdateEventRequest
	5,  // 13: event.EventService.UpdateEventNotify:input_type -> event.UpdateEventNotifyRequest
	7,  // 14: event.EventService.DeleteEvent:input_type -> event.DeleteEventRequest
	9,  // 15: event.EventService.GetEvent:input_type -> event.GetEventRequest
	11, // 16: event.EventService.GetEvents:input_type -> event.GetEventsRequest
	13, // 17: event.EventService.GetEventsUpTo:input_type -> event.GetEventsUpToRequest
	2,  // 18: event.EventService.CreateEvent:output_type -> event.CreateEventResponse
	4,  // 19: event.EventService.UpdateEvent:output_type -> event.UpdateEventResponse
	6,  // 20: event.EventService.UpdateEventNotify:output_type -> event.UpdateEventNotifyResponse
	8,  // 21: event.EventService.DeleteEvent:output_type -> event.DeleteEventResponse
	10, // 22: event.EventService.GetEvent:output_type -> event.GetEventResponse
	12, // 23: event.EventService.GetEvents:output_type -> event.GetEventsResponse
	12, // 24: event.EventService.GetEventsUpTo:output_type -> event.GetEventsResponse
...
func file_EventService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_EventService_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetEventsUpToRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
